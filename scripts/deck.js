...
{
  this.cards = [
    new Card_Potion("A",14,HEART,"Super Potion"),
    ...
    new Card_Potion("V",11,HEART,"Super Potion"),
    new Card_Potion("Q",12,HEART,"Super Potion"),
    new Card_Potion("K",13,HEART,"Super Potion"),
    new Card_Shield("A",14,DIAMOND,"Tower Shield"),
    ...
    new Card_Shield("V",11,DIAMOND,"Tower Shield"),
    new Card_Shield("Q",12,DIAMOND,"Tower Shield"),
    new Card_Shield("K",13,DIAMOND,"Tower Shield"),
    new Card_Monster("A",14,CLOVE,"Fallen"),
    ...
    new Card_Monster("A",14,SPADE,"Fallen"),
    ...
    new Card_Monster("Q",12,SPADE,"Merfolk Queen"),
    new Card_Monster("K",13,SPADE,"Undead King"),
