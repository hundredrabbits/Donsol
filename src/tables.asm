...
dialogs:                       ; [skip]
  ...
  .db $23,$33,$39,$00,$27,$25,$32,$32,$33,$38,$00,$36,$39,$32,$00,$25,$3b,$25,$3d,$69,$00,$00,$00,$00; cannot_run 04
  ...
  .db $0f,$25,$37,$3d,$00,$17,$33,$28,$29,$00,$6c,$00,$1d,$29,$30,$29,$27,$38,$00,$27,$25,$36,$28,$69; easy mode 0d
...
cards_offset_low:              ; 
  .db #<(cards+(#$36* 0)),#<(cards+(#$36* 1)),#<(cards+(#$36* 2)),#<(cards+(#$36* 3)),#<(cards+(#$36* 4)),#<(cards+(#$36* 5)),#<(cards+(#$36* 6)),#<(cards+(#$36* 7)),#<(cards+(#$36* 8)),#<(cards+(#$36* 9))
  .db #<(cards+(#$36*10)),#<(cards+(#$36*11)),#<(cards+(#$36*12)),#<(cards+(#$36*13)),#<(cards+(#$36*14)),#<(cards+(#$36*15)),#<(cards+(#$36*16)),#<(cards+(#$36*17)),#<(cards+(#$36*18)),#<(cards+(#$36*19))
  .db #<(cards+(#$36*20)),#<(cards+(#$36*21)),#<(cards+(#$36*22)),#<(cards+(#$36*23)),#<(cards+(#$36*24)),#<(cards+(#$36*25)),#<(cards+(#$36*26)),#<(cards+(#$36*27)),#<(cards+(#$36*28)),#<(cards+(#$36*29))
  .db #<(cards+(#$36*30)),#<(cards+(#$36*31)),#<(cards+(#$36*32)),#<(cards+(#$36*33)),#<(cards+(#$36*34)),#<(cards+(#$36*35)),#<(cards+(#$36*36)),#<(cards+(#$36*37)),#<(cards+(#$36*38)),#<(cards+(#$36*39))
  .db #<(cards+(#$36*40)),#<(cards+(#$36*41)),#<(cards+(#$36*42)),#<(cards+(#$36*43)),#<(cards+(#$36*44)),#<(cards+(#$36*45)),#<(cards+(#$36*46)),#<(cards+(#$36*47)),#<(cards+(#$36*48)),#<(cards+(#$36*49))
  .db #<(cards+(#$36*50)),#<(cards+(#$36*51)),#<(cards+(#$36*52)),#<(cards+(#$36*53)),#<(cards+(#$36*54)),#<(cards+(#$36*55))
cards_offset_high:             ; 
  .db #>(cards+(#$36* 0)),#>(cards+(#$36* 1)),#>(cards+(#$36* 2)),#>(cards+(#$36* 3)),#>(cards+(#$36* 4)),#>(cards+(#$36* 5)),#>(cards+(#$36* 6)),#>(cards+(#$36* 7)),#>(cards+(#$36* 8)),#>(cards+(#$36* 9))
  .db #>(cards+(#$36*10)),#>(cards+(#$36*11)),#>(cards+(#$36*12)),#>(cards+(#$36*13)),#>(cards+(#$36*14)),#>(cards+(#$36*15)),#>(cards+(#$36*16)),#>(cards+(#$36*17)),#>(cards+(#$36*18)),#>(cards+(#$36*19))
  .db #>(cards+(#$36*20)),#>(cards+(#$36*21)),#>(cards+(#$36*22)),#>(cards+(#$36*23)),#>(cards+(#$36*24)),#>(cards+(#$36*25)),#>(cards+(#$36*26)),#>(cards+(#$36*27)),#>(cards+(#$36*28)),#>(cards+(#$36*29))
...
shuffle4:                      ; 
  .db $2c,$06,$35,$2f,$0b,$34,$2d,$22,$16,$07,$1a,$12,$0d,$1f
  .db $05,$0c,$0e,$2a,$1b,$24,$1d,$18,$33,$2b,$32,$0f,$11,$1e
  .db $25,$27,$20,$2e,$08,$02,$14,$28,$23,$1c,$31,$30,$03,$21
  .db $0a,$00,$17,$15,$29,$04,$19,$09,$26,$01,$13,$10
shuffle5:                      ; 
  .db $14,$26,$00,$11,$06,$08,$24,$1c,$12,$1d,$0c,$2b,$30,$15
  .db $02,$10,$18,$1b,$2c,$0d,$2f,$19,$0f,$17,$32,$22,$01,$0a
  .db $2e,$25,$03,$05,$23,$13,$20,$28,$29,$35,$2a,$21,$27,$1e
  .db $33,$2d,$34,$31,$0b,$16,$09,$1a,$1f,$07,$04,$0e
shuffle6:                      ; 
  .db $15,$09,$0c,$0f,$17,$1e,$34,$28,$2b,$25,$30,$23,$0a,$11
  .db $00,$12,$1c,$0e,$22,$0b,$10,$32,$13,$1b,$19,$33,$1a,$2f
  .db $18,$2c,$1d,$24,$06,$04,$2a,$14,$20,$35,$2d,$05,$03,$02
  .db $29,$1f,$01,$16,$21,$26,$08,$2e,$0d,$07,$27,$31
shuffle7:                      ; 
  .db $1b,$0b,$07,$1c,$10,$0e,$0a,$31,$25,$00,$09,$0f,$28,$27
  .db $14,$19,$17,$08,$15,$06,$02,$30,$2a,$16,$03,$12,$2e,$22
  .db $01,$35,$0d,$2b,$18,$1a,$05,$1f,$2d,$04,$23,$2f,$1d,$34
  .db $32,$24,$26,$1e,$2c,$0c,$13,$20,$33,$29,$11,$21